...
$$
\Y_{t} = \beta_0 + \underbrace{\beta_1\ \X_{1,t} + \beta_2\ \X_{2,t}}_{\text{from current time}} + \underbrace{\beta_3 \ \Y_{t-1}}_{\text{from prior time}} + \eps_{t}
$$
...
digraph example2 {
  bgcolor="transparent";
  // Nodes
  Y1 [shape=box, pos = "0,0!", label="Outcome (t-1)"]
  X1 [shape=box, pos = "2,0!", label="Input 1 and 2"]
  Y2 [shape=box, pos = "0,0!", label="Outcome (t)"]
