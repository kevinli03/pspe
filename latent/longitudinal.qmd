...
Let us say we have some latent outcome variable, which is measured by observed items. We also have a few observed input variables:
...
$$
\Y_{it} = \beta_0 + \beta_1\ \X_{1,it} + \beta_2\ \X_{2,i} + \underbrace{\beta_3 \ \Y_{i, t-1}}_{\text{from prior time}} + \eps_{it}
$$
