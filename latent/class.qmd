...
The factors a categorical variable with $C$ number of categories, which are also called **latent classes**. These categories are treated as if they have no inherent order, and we can choose the number of categories.
...
$$
\begin{align}
Pr(\text{item}_1 = \text{category }k \ | \ \text{factor} = \text{category }c) & = \pi_{1, kc} \\
Pr(\text{item}_2 = \text{category }k  \ | \ \text{factor} = \text{category }c) & = \pi_{2, kc} \\
\vdots \qquad \qquad \vdots \qquad \qquad & \vdots \\
Pr(\text{item}_p = \text{category }k  \ | \ \text{factor} = \text{category }c) & = \pi_{p, kc} \\
\end{align}
$$
...
$$
\alpha_c = Pr(\text{factor}=\text{category }c)
$$
...
$$
\widehat{Pr}(\text{factor} = \text{category }c \ | \ \text{item}_1 = \text{category }k_1, \text{item}_2 = \text{category }k_2, \dots )
$$
