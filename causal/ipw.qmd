...
The weights/emphasis an individual by the inverse of their likelihood to receive treatment. This is estimated as the inverse of the [propensity score](pscore.qmd).
...
|                                                                                                                                              |                                                                                                                                                       |
| 2\) Does not throw out data like matching does.                                                                                              |                                                                                                                                                       |
+----------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
