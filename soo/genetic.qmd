...
$$
\tau_{\text{Mia}} = \textcolor{purple}{\text{outcome}^{(\text{treated})}_\text{Mia}} - \textcolor{red}{\text{outcome}^{(\text{control})}_\text{Mia}}
$$
...
$$
\tau_{\text{Mia}} \approx \textcolor{purple}{\text{outcome}^{(\text{treated})}_\text{Mia}} - \textcolor{purple}{\text{outcome}^{(\text{control})}_\text{Matched individual}} 
$$
