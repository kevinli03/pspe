...
$$
\tau_\text{treated} = \textcolor{purple}{{\text{outcome}}_{\text{treated}}^{(\text{treated})}} - \textcolor{red}{{\text{outcome}}_{\text{treated}}^{(\text{untreated})}}
$$
...
$$
\begin{align}
\text{correlation} & =  \text{outcome}_\text{treated} - \text{outcome}_\text{untreated} \\
& = \textcolor{purple}{\text{outcome}_{\text{treated}}^{(\text{treated})}} - \textcolor{purple}{\text{outcome}_\text{untreated}^{(\text{untreated})}}
\end{align}
$$
...
$$
\text{if  } \textcolor{purple}{\text{outcome}_\text{untreated}^{(\text{untreated})}} ≠ \textcolor{red}{\text{outcome}_\text{treated}^{(\text{untreated})}}, \text{ then }  \tau_\text{treated} ≠ \text{correlation}
$$
