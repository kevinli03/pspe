...
$$
\tau_\text{treated} = \textcolor{purple}{{\text{health}}_{\text{went}}^{(\text{treated})}} - \textcolor{red}{{\text{health}}_{\text{went}}^{(\text{control})}}
$$
...
& = \textcolor{purple}{\text{health}_{\text{went}}^{(\text{treated})}} - \textcolor{purple}{\text{health}_\text{did not go}^{(\text{control})}}
\end{align}
$$
...
$$
\text{if  } \textcolor{purple}{\text{health}_\text{did not go}^{(\text{control})}} ≠ \textcolor{red}{\text{health}_\text{went}^{(\text{control})}}
$$
