...
$$
\tau_\text{Dec92} = \purple{\text{outcome}^{(\text{treated})}_\text{Dec92}} - \red{\text{outcome}^{(\text{control})}_\text{Dec92}}
$$
...
$$
\begin{align}
\tau_\text{Dec92} &  = \purple{\text{outcome}^{(\text{treated})}_\text{Dec92}} - \red{\text{result}^{(\text{control})}_\text{Dec92}} \\
& \approx \purple{\text{outcome}^{(\text{treated})}_\text{Dec92}} - \left( \purple{\text{outcome}^{(\text{control})}_\text{Mar92}}  - 2.16\right)
\end{align}
$$
