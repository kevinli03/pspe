...
$$
\tau_\text{Dec92} = \purple{Y^{(\text{treated})}_\text{Dec92}} - \red{Y^{(\text{untreated})}_\text{Dec92}}
$$
...
\begin{align}
\tau_\text{Dec92} &  = \purple{Y^{(\text{treated})}_\text{Dec92}} - \red{Y^{(\text{untreated})}_\text{Dec92}} \\
& \approx \purple{Y^{(\text{treated})}_\text{Dec92}} - \left( \purple{Y^{(\text{untreated})}_\text{Mar92}}  - 2.16\right)
\end{align}
$$
