...
Gardner (2021) proposes to solve the [issues with two-way fixed effects](twfestaggered.qmd) by just not doing comparisons and weighting. Instead, we estimate the missing counterfactuals and then calculate the treatment effect.
