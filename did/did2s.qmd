...
The [TWFE estimator](twfe.qmd) implies that untreated units $D_{it} = 0$ equals the following:
...
::: small
This is another fancy way of explaining the [forbidden comparisons problem](staggered.qmd) - in TWFE, $Y_{it}(D_{it} = 0)$ is mis-estimated to include already-treated units, which is the forbidden comparison.
:::
