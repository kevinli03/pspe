...
TWFE compares groups that [can be "forbidden" or incorrect](staggered.qmd), such as using already-treated units as controls. Liu et al (2024) instead proposes to estimate individual counterfactual untreated outcomes for treated units, and directly calculating the individual treatment effects:
