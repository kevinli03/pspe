...
::: small
Where controls are extra variables needed to be controlled for meet the parallel trends assumption (optional). Note how coefficients $\alpha_i$ and $\gamma_t$ have subscripts - they have different values given which unit $i$ or time $t$ in question.
:::
