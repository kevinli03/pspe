...
::: small
Where covariates are extra control variables needed to meet the parallel trends assumption (optional). Note how coefficients $\alpha_i$ and $\gamma_t$ have subscripts - they have different values given which unit $i$ or time $t$ in question.
:::
