...
$$
\begin{align}
Y_{it} = \sum\limits_\text{group} & \sum\limits_{k ≠ -1} \blue{\tau_{\text{group}, k}} \cdot 1\{i \in \text{group}\} \cdot 1\{t-\text{group}=k\} \\
