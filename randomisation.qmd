...
::: small
This chapter covers how randomisation solves the problem of selection bias, and why randomisation is considered the "gold standard" of causal inference.
:::
...
$$
\textcolor{purple}{\text{outcome}_\text{untreated}^{(\text{control})}} = \textcolor{red}{\text{outcome}_\text{treated}^{(\text{untreated})}}
$$
