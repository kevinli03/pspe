MathJax = {
    tex: {
      macros: {
        ...
        pT: "{\\textcolor{purple}{\\text{outcome}^{(\\text{treated})}}}",
        pTred: "{\\textcolor{red}{\\text{outcome}^{(\\text{treated})}}}",
        pC: "{\\textcolor{purple}{\\text{outcome}^{(\\text{control})}}}",
        pCred: "{\\textcolor{red}{\\text{outcome}^{(\\text{control})}}}",
        Y: "{\\text{outcome}}",
        D: "{\\text{treatment}}",
        X: "{\\text{input}}",
        cov: "{\\text{covariates}}",
